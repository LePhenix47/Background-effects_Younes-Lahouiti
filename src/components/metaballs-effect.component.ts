import { MetaballsEffectCreator } from "../utils/classes/effects/metaballs-effect-creator.class";
import {
  get2DContext,
  setCanvasSize,
...
class MetaballsEffect extends HTMLElement {
   ...
   * @type {MetaballsEffectCreator}
   */
  effectHandler: MetaballsEffectCreator;
