import { FireEffectCreator } from "../utils/classes/effects/fire-effect-creator.class";
import {
  get2DContext,
  setCanvasSize,
...
class FireEffect extends HTMLElement {
   ...
   * @type {FireEffectCreator}
   */
  effectHandler: FireEffectCreator;
  ...
  constructor() {
    ...
    const clonedTemplate: Node =
      fireEffectTemplateElement.content.cloneNode(true);
